...
extension SDL_uikitviewcontroller {
    ...
    var useButton:UIButton {
        get {
            return Holder._useButton
        }
        set(newValue) {
            Holder._useButton = newValue
        }
    }
    ...
    var crouching:Bool {
        get {
            return Holder._crouching
        }
        set(newValue) {
            Holder._crouching = newValue
        }
    }
    
    var factor:CGFloat {
        get {
            return Holder._factor;
        }
        set (newValue) {
            Holder._factor = newValue
        }
    }
...
//        buttonStack.addArrangedSubview(tildeButton)
    ...
    @objc func usePressed(sender: UIButton!) {
        Key_Event(102, qboolean(1), qboolean(1))
    }
    
    @objc func useReleased(sender: UIButton!) {
        Key_Event(102, qboolean(0), qboolean(1))
    }
...
//        Key_Event(99, qboolean(0), qboolean(1))
//    }
